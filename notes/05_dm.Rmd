...
`r emo::ji("warning")` If you get an error message saying something like <span style="color:red;">function not found</span>, that is a message to you that you need to load the library. See the [preparation](#preparation) section of these notes to remind yourself how to do this. 

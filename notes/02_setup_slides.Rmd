...
Note in this last package that is a lower case letter L at the end. For "read EXCEL." It is not the number 1 (one). 
...
Unfortunately in person `r emo::ji("busts_in_silhouette")` help not available during Spring 21 due to COVID19 `r emo::ji("mask")`

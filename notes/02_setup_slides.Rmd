...
##  Retain sanity while troubleshooting `r emo::ji("cinema")`
...
To effectively resetart R, go to the file menu and click _Session_ , then "Restart R", or "Restart R and clear output". 
...
.pull-left[<br>
`r emo::ji("pencil2")` Type these commands into the console one at a time and wait for it to finish before entering the next command.
]

...
If you are using a tablet, Chromebook or otherwise do not have a computer that you can install programs on, you can use R Studio Cloud for this class. Make an account at http://rstudio.cloud, start a new project, then go to [slide #6](#intro_rstudio) to learn how to navigate RStudio. 

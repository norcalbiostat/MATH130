...
If you are using a tablet, Chromebook or otherwise do not have a computer that you can install programs on, you can use R Studio Cloud for this class. Make an account at http://rstudio.cloud.com, start a new project, then go to [slide #6](#intro_rstudio) to learn how to navigate RStudio. 

The **Cloud Free** account allows for 25 project hours/month, which may not be enough for this class. If you run into time limits or you are using this for another class you will have to upgrade to the **Cloud Plus** plan which is $5/month. 
...
## `r emo::ji("arrow_down_small")` Download R v 4.1+
...
## `r emo::ji("arrow_down_small")` Download v1.4 + 
* [Download R Studio (v 1.4+)](https://www.rstudio.com/products/rstudio/download/#download) 
...
`r emo::ji("pencil2")` Watch the following short video to learn how to navigate R Studio.
...
For Spring 21 help is available both in person, and online. 

* For in-person sections ask the person sitting next to you! Don't hesitate to talk to your neighbor, compare your answers, and ask for help.
* Ask in [Discord](https://discord.gg/ck497bJty5 ) - we have a dedicated channel just for this class but a lot of students in the server know how to use R. 
...
* Twitter: [#rstats](https://twitter.com/search?q=%23rstats&src=typed_query&f=top) [@Rstudio](https://twitter.com/rstudio)

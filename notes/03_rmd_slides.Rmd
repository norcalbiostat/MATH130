...
`r emo::ji("cinema")` Watch this 1 minute video on [What is R Markdown?](http://rmarkdown.rstudio.com/lesson-1.html)
...
* On the same page as the video you watched earlier, there are additional lessons on using R Markdown. If you want to learn more from this site, here is the full URL http://rmarkdown.rstudio.com/lesson-1.html

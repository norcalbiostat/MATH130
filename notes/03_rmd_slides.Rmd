...
Some instructors may require you to use **Quarto** instead of **R Markdown**. Quarto is the next generation of Rmarkdown files.  

You are welcome to use either in this class. Functionally they act the same, Quarto just has more nifty features. 

This class continues to teach RMarkdown but will be upgrading soon.
...
.left-column[.footnote[*Image credit on next page: Data Visualization by Kieran Healy. Available at http://socviz.co/*]]

---
background-image: url('../static/img/rmarkdown_components.png')
...
`r emo::ji("pencil2")` Let's create your first markdown file!
...
`r emo::ji("warning")` If you are asked to install additional packages, go ahead and say yes. Then go back to [lesson 02](02_setup_slides.html) and make sure you have all the necessary packages listed. 

---
# Make a change

`r emo::ji("pencil2")`  Play around with modifying the text and the R code.
...
* Learn more about Quarto at https://quarto.org/docs/get-started/hello/rstudio.html 

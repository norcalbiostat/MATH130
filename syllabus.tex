...
\begin{longtable}[]{@{}
  ...
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3378}}
  >{\centering\arraybackslash}p{(\columnwidth - 4\tabcolsep) * \real{0.3378}}@{}}
\toprule()
...
\midrule()
\endhead
\textbf{Meeting Days} & 01/22/24 - 02/23/24 & 01/22/23 - 02/23/24 \\
\textbf{Meeting Times} & (Asynchronous) & (Asynchronous) \\
\textbf{Meeting Location} & (Asynchronous) & (Asynchronous) \\
...
Both sections of this class are fully online, asynchronous. There are no
set meeting times, but assignments still have due dates. Lectures are
all pre-recorded and linked from the class website. Students work
through the material and complete assignments at their own pace. See
...
were originally oc- cupied by the first people of this area, the
...
special permission by the instructor is 2/2/24. No adds or drops are
allowed after 2/16/24 without a serious and compelling reason approved

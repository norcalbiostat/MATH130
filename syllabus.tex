...
\hypersetup{
  pdftitle={Math 130: Introduction to R - Fall 21},
  hidelinks,
...
\title{Math 130: Introduction to R - Fall 21}
\author{}
\date{\vspace{-2.5em}}
...
\midrule
\endhead
\textbf{Meeting Days} & 08/23/21 - 09/24/21 & 08/23/21 -
09/24/21\tabularnewline
\textbf{Meeting Times} & MWF 2:00-2:50 pm & MWF 10:00 - 10:50
am\tabularnewline
\textbf{Meeting Location} & Online & Online\tabularnewline
\textbf{Instructor} & Nicholas Lytal & Robin Donatello\tabularnewline
\textbf{Office Location} & Holt 106 & Holt 202\tabularnewline
\textbf{E-mail} &
\href{mailto:nlytal@csuchico.edu}{\nolinkurl{nlytal@csuchico.edu}} &
\href{mailto:rdonatello@csuchico.edu}{\nolinkurl{rdonatello@csuchico.edu}}\tabularnewline
\bottomrule
\end{longtable}

\hypertarget{additional-support-community-coding.}{%
\subsection{Additional Support: Community
Coding.}\label{additional-support-community-coding.}}
...
virtual lab}, or use R Studio Cloud (\url{https://rstudio.cloud/}) - the
free or \$5/month plan should be sufficent.
...
special permission by the instructor is 9/3/21. No adds or drops are
allowed after 9/20/20 without a serious and compelling reason approved

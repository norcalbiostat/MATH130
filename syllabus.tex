...
\hypersetup{
  pdftitle={Math 130: Introduction to R - Spring 21},
  hidelinks,
...
\title{Math 130: Introduction to R - Spring 21}
\author{}
\date{\vspace{-2.5em}}
...
\midrule
\endhead
\textbf{Meeting Days} & 1/25/20 - 2/26/20 & Not Offered\tabularnewline
\textbf{Meeting Times} & MWF 11:00-11:50 &\tabularnewline
...
\item
  ...
  schedule of events.
\item
  Community Coding: Times TBD. \href{https://www.csuchico.edu/datascience/community-coding.shtml}{{[}main page{]}}
...
special permission by the instructor is \textbf{2/5/21}. No adds or drops are
allowed after \textbf{2/19/21} without a serious and compelling reason approved

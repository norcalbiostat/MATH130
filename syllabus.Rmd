---
title: "Math 130: Introduction to R - Fall 21"
fontsize: 11pt
output:
  pdf_document:
    keep_tex: yes
...
|:-----------------------|:-----------------------:|:-----------------------:|
| **Meeting Days**       | 08/23/21 - 09/24/21     |  08/23/21 - 09/24/21    |
| **Meeting Times**      | MWF 2:00-2:50 pm        |  MWF 10:00 - 10:50 am   |
...
Similar to drop in Mathematics tutoring hours, students, staff, faculty, and the public are invited to join our Community Coding sessions. Bring your computer, coding projects, and your questions to this open working environment. 
...
* R version 4.0.0 or later. Download from https://cran.r-project.org/
...
Students who do not have a computer that they install programs on (i.e. a iPad or Chromebook) can use the [Wildcat virtual lab](https://support.csuchico.edu/TDClient/1984/Portal/KB/ArticleDet?ID=112333), or use R Studio Cloud (https://rstudio.cloud/) - the free or $5/month plan should be sufficent.  

---
title: "Math 130: Introduction to R - Spring 22"
fontsize: 11pt
output:
  pdf_document:
    keep_tex: yes
...
|:-----------------------|:-----------------------:|:-----------------------:|
| **Meeting Days**       | 01/24/22 - 02/25/22     |  01/24/22 - 02/25/22    |
| **Meeting Times**      | MWF 10 - 10:50 am       |  No set meeting pattern |
| **Meeting Location**   | Holt 257                |  Online                 |
| **Instructor**         | Nicholas Lytal          |  Robin Donatello        |
| **Office Location**    | Holt 106                |  Holt 202               |
| **E-mail**             | nlytal@csuchico.edu     |  rdonatello@csuchico.edu|

## Asynchronous sections
At least one section of this class is fully online, asyncronous. This means there are no set meeting times, but assignments still have due dates. Lectures are all pre-recorded and linked from the class website. Students work through the material and complete assignments at their own pace. Instructor availability will be described in Blackboard Learn.

## Blackboard Learn Useage
See the welcome page for your section in Blackboard Learn for specific information on how BBL will be used for your section. 

## Discord 
To facilitate peer to peer and effective instructor to peer assistance Discord will be used for discussion and questions outside of class. This server hosts students across multiple Statistics and Data Science classes, with a specific channel for all sections of Math 130. You must assign yourself the `math130` role to access the channels for this class.  

1. Click this link to join the server: https://discord.gg/ck497bJty5
2. Agree to the rules and code of conduct
3. Assign a role to yourself by 

Walkthrough video: 

## Additional Support: Community Coding. 
...
# Grading
Credit / No Credit. There are 100 points available in this course. You must earn 70 points to receive credit for the course. See Blackboard Learn for instructions on how to submit your work and due dates. 

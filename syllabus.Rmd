---
title: "Math 130: Introduction to R - Fall 20"
fontsize: 11pt
output:
  pdf_document:
    keep_tex: yes
...
|:-----------------------|:-----------------------:|:-----------------------:|
| **Meeting Days**       | 8/24/20 - 9/25/20       |  Not Offered    |
| **Meeting Times**      | MWF 9:00-9:50           |            |
| **Meeting Location**   | Online                |                 |
| **Instructor**         | Nicholas Lytal         |           |
| **Office Location**    | N/A                  |                 |
| **Office Phone**       | N/A                  |                 |
| **E-mail**             | nlytal@csuchico.edu  |      |
...
* Community Coding: Times TBD. [[flyer]](bit.ly/cc_hours)
...
* R Studio version 1.39 or later. Download the desktop version from https://www.rstudio.com/products/rstudio/download/#download
...
* If you have a name and/or set of pronouns that differ from those that appear in your official Chico records, please let me know!
...
Furthermore, I would like to acknowledge that we are meeting on the traditional lands of the Mechoopda people. Without them, we would not have access to this campus or our education.
...
### IT Support Services
During the COVID-19 pandemic, the physical office for ITSS is closed until further notice. However, most services are still available via phone, online, or in a [Zoom Lobby](https://csuchico.zoom.us/j/5308984357?pwd=WUwwaXJQUTNPSnJqc1hTemxPY0ZiQT09) during business hours. See the [ITSS webpage](https://www.csuchico.edu/itss/) for futher details. 

...
4. What type of data is `my_fruit`? Use a function discussed in lesson 04 to have R show the answer to this question.
```{r}
...
5. Do any houses have more than 2 fireplaces (`Fireplaces`)? _Hint: Use the `table()` function._

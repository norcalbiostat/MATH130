...
* Knit your file to HTML, WORD, or PDF, then upload to Box [[using this link]](https://csuchico.app.box.com/f/44dd8d9cef9b4b219efb09b1eb3e5b33) by the due date. 
    - **If you knit to HTML, you must open & save the resulting file as PDF so it can be commented on.**
* You must put your student username in the name of the file.
...
1. Go to the [[project page]](https://norcalbiostat.github.io/peer_review/math130_eda.html) and find the projects you are assigned to review. 
2. Download the projects that you have been assigned to review. 
3. If one or both of the people you are assigned to review do not submit a project, pick another person to review. You do not have to notify your instructor if this happens.
4. Using the commenting feature provide 4 comments for each project.
...
5. Score each project using this [Google Form](https://goo.gl/forms/7I4zsYpSsiZpgKyH3).

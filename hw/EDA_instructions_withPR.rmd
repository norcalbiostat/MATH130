...
Any other data sets require instructor approval. Data sets such as the 'plants' or arm strength' data sets are insufficiently complex for this project. Also you can't use the `dsmall`, `diamonds`, `email` or `NCbirths` data sets because we've used them too much already.
...
* Knit your file to HTML, WORD, or PDF, then upload to Google Drive using the link below for your section the due date.
    - [Spring 20 - Section 01](https://drive.google.com/drive/folders/1DL1TGF0MK7riJl9tAOUCNVK565UmjCt3?usp=sharing)
...
After the submission deadline, your analysis projects will be randomly assigned to two other projects to peer review and score. This means you will score and provide feedback on 2 reports. The instructor(s) will also score all projects for their class sections.
...
* Your assignments will be posted here. If one or both of the people you are assigned to review do not submit a project, pick another person to review. You do not have to notify your instructor if this happens.
  ...
  - [Spring 20 - Section 01](https://docs.google.com/spreadsheets/d/1gcxGsuRZKeyR6khSiVcuMyR5ACryZNiJYrgHkfyyI3M/edit?usp=sharing)
...
* Score each project using this [Google Form](https://goo.gl/forms/7I4zsYpSsiZpgKyH3).
    ...
    - You will upload both projects you reviewed to this form as well.
